...
HD_PWD='C:/Users/SZHerio/Desktop/APS/09.LSU_Integration/09.LSU_Integration.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_processor_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nexys_processor_system.tcl
