...
HD_PWD='C:/Users/SZHerio/Desktop/APS/07.Datapath/07.Datapath.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_processor_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nexys_processor_system.tcl -notrace
